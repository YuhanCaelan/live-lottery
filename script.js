...
function setSettingsPage(page) {
  ...
  el.settingsPageTabBtn.classList.toggle('is-active', true);
  el.photoPageTabBtn.classList.toggle('is-active', false);
  el.settingsPageTabBtn.setAttribute('aria-selected', 'true');
  el.photoPageTabBtn.setAttribute('aria-selected', 'false');
  el.settingsPageTitle.textContent = '不参与座位与抽奖轮次';
}
